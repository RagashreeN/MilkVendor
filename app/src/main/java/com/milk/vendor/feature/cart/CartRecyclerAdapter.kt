...
import com.milk.vendor.databinding.ListCartsBinding
import com.milk.vendor.feature.cart.CartActivity.Companion.arraylistCart

class CartRecyclerAdapter (var arrayList:ArrayList<ProductList>, var context: Context,var interfaceUpdateUI :  UpdateUI) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    inner class ViewHolderRV(val listProductsBinding: ListCartsBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val applicationBinding =
            ListCartsBinding.inflate(layoutInflater, parent, false)

        val rowActivityRecyclerViewVM: CartRowVM = ViewModelProviders.of(parent.context as FragmentActivity)
            .get(CartRowVM::class.java)

        applicationBinding.cartRowVM = rowActivityRecyclerViewVM
